...
public class AdminApprover implements Approver {
  private Approver nextApprover;

  public AdminApprover(Approver nextApprover) {
  ...
  public void approveRequest(PurchaseOrder purchaseOrder) {
    ...
    if (purchaseOrder.getAmount() >= 1000 && purchaseOrder.getAmount() < 10000){
      System.out.println("Admin has approved the purchase order of amount: " + purchaseOrder.getAmount());
